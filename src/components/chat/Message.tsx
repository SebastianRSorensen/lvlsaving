...
const Message = forwardRef<HTMLDivElement, MessageProps>(({ message, isNextMessageSameSender }, ref) => {
    return (
        <div ref={ref}
            ...
            <div className={cn("relative flex h-6 w-6 aspect-square items-center justify-center", {
                ...
                invisible: isNextMessageSameSender,
            })}>
            ...
            <div
                ...
                <div className={cn(
                    ...
                    "rounded-br-none": !isNextMessageSameSender && message.isUserMessage,
                    "rounded-bl-none": !isNextMessageSameSender && !message.isUserMessage,
                }
                )}>
